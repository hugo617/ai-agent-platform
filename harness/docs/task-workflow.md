...
3. 读 `feature_list.json` —— 找当前 `in_progress`,或下一个 `not_started`
...
4. 对照 `harness/clean-state-checklist.md` 收尾
...
└── docs/
    ...
    ├── plan-global-rename.md    ← 任务:全局改名 的实施步骤计划
    └── plan-<任务id>.md         ← (未来)其他任务的实施计划
```
