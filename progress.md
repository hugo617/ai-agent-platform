...
定向 `pytest tests/test_billing_reconciliation.py -q` **15/15**(11 旧 + 4 新零回归);ruff 全绿;全量 `pytest -ra --strict-markers` **1062 passed, 8 skipped**(基线 1059 + 新增 3,零回归);前端 `npm run build` 绿(1.93s,零前端改动确认)。
